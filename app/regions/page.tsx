...
import { REGION_PINS, type RegionScoreView } from "@/lib/sonar-data";
  ...
  return (
    <PageFrame wide>
      <PageIntro
        ...
        title="Regional breakdown"
        description="Geographic visibility matters. Each region contributes an independent view of validator reachability and slot propagation."
        aside={<StatusPill active={source === "onchain"}>{source === "onchain" ? `${activeRegions.length} active regions` : "Placeholder fallback"}</StatusPill>}
      />
